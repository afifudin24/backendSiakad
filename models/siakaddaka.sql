...
--
-- Host: localhost
-- Generation Time: Dec 29, 2024 at 09:23 AM
...
CREATE TABLE `datamengajar` (
  ...
  `jamMengajar` int(11) NOT NULL DEFAULT 4,
  `pertemuanPerMinggu` int(11) NOT NULL DEFAULT 2
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `datamengajar` (`id`, `guru_id`, `mapel_id`, `kelas_id`, `jamMengajar`, `pertemuanPerMinggu`) VALUES
(1, 8, 1, 3, 4, 2),
(2, 9, 1, 3, 4, 2),
(5, 8, 1, 1, 4, 2);
