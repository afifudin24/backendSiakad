...
router.get('/byKelasId/:id', JadwalMengajarController.getJadwalMengajarByKelasId);
router.get('/byKelasIdHari/:id/:hari', JadwalMengajarController.getJadwalMengajarByKelasIdHari);
router.get('/byGuruIdHari/:id/:hari', JadwalMengajarController.getJadwalMengajarByGuruIdHari);
